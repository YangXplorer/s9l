...
- **已支持数据库**：SQLite、PostgreSQL、MySQL、SQL Server、ClickHouse（纯 Go 驱动 `modernc.org/sqlite`、`jackc/pgx/v5/stdlib`、`go-sql-driver/mysql`、`microsoft/go-mssqldb`、`ClickHouse/clickhouse-go/v2`，均免 CGO）。
